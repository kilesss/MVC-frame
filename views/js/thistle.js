...
console.log('1');
  console.log(ApendDiv);  
  var b, g, m, r, rgb, s;
    s = document.createElement('span');
    document.getElementById(ApendDiv).appendChild(s);
    s.style.backgroundColor = cssColor;
    rgb = getComputedStyle(s).backgroundColor;
    document.getElementById(ApendDiv).removeChild(s);
  ...
  Picker = (function() {
    ...
    function Picker(color,ApendDiv) {
window.ApendDiv = ApendDiv;
console.log('2');
    ...
    Picker.prototype.presentModal = function(x, y) {
      ...
      modalFrame.onclick = (function(_this) {
        return function() {
          var end;
          document.getElementById(ApendDiv).removeChild(modalFrame);
          _this.el.style.top = y + 10 + 'px';
          _this.el.style.opacity = 0;
          end = function() {
            document.getElementById(ApendDiv).removeChild(_this.el);
      ...
      document.getElementById(ApendDiv).appendChild(modalFrame);
      document.getElementById(ApendDiv).appendChild(this.el);
