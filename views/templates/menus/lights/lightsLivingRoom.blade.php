            ...
            <div class="col-md-12  btn" id="light11Main">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="switch demo3" >
                        	    <input type="checkbox" id="lightsLivinglight2" onchange="switchLights('lightsLiving','light2')">
                        		<label><i></i></label>
                        	</div>
                        </div>
                    </div>
                    <div class="row" style="border-top: 5px solid silver; margin-top: 10px">
                        <div class="col-md-6">
                            <div class="switch demo3"  style="height: 25px">
                                <input type="checkbox" id="generallightsLiving" onchange="switchLights('lightsLiving','general')">
                                    <label><i></i></label>
                             </div>
                        </div>
                        <button   class="col-md-6 btnEditLights" type="button" data-toggle="modal" data-target="#lightsLivingroom">
                            Edit
                        </button>
                    </div>
                         </div>
