                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="switch demo3" >
                    	    <input type="checkbox" id="lightsKitchenlight1" onchange="switchLights('lightsKitchen','light1')">
                    		<label><i></i></label>
                    	</div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="switch demo3" >
                        	    <input type="checkbox" id="lightsKitchenlight2" onchange="switchLights('lightsKitchen','light2')">
                        		<label><i></i></label>
                        	</div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="switch demo3"  style="height: 25px">
                            <input type="checkbox" id="generallightsKitchen" onchange="switchLights('lightsKitchen','general')">
                                <label><i></i></label>
                        </div>
                    </div>
                        <button   class="col-md-6 btnEditLights" type="button" data-toggle="modal" data-target="#kitchenLight1">
                            Edit
                        </button>
                    </div>
                         </div>
...
@include('modal.lights.kitchenModal')
