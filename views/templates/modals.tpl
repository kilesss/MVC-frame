...
{*{{--<div class="modal fade" id="v2lightsKitchen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">--}}*}
{*{{--<div class="modal fade" id="v2lightsEntranseHall" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">--}}*}


{*{{--<div class="modal fade" id="v2lightsTerrace" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">--}}*}
